...
<body>
	<table cellspacing=0 cellpadding=0 width="100%" align=center border=0>
		<tr height=28><td background="images/title_bg1.jpg">当前位置 &raquo; 用户管理</td></tr>
	...
	<div id="usermsg" class="jqmWindow" style="width: 300px;">
		...
		<form id="form" method="post">
			<table align="center">
				<tr><td>用户:</td><td><input type="text" name="user.username" ></td></tr>
				<tr><td>密码:</td><td><input type="text" name="user.password"></td></tr>
				<tr><td>邮箱:</td><td><input type="text" name="user.email"></td></tr>
				<tr><td>简介:</td><td><input type="text" name="user.intro"></td></tr>
			</table>
			<div align="center">
